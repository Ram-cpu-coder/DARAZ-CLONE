...
const IndividualFlashCard = () => {
  ...
  return (
    <div className="flex flex-col">
      <div className="w-full flex flex-col items-center bg-[#eff0f5]">
              ...
              <div className="flex flex-col gap-4 w-[25%] p-2 bg-[#fafafa]">
                <div className="flex flex-col">
                  ...
                  <div className="flex justify-between items-center">
                    <p className="flex items-center gap-2">
                      <SlLocationPin className="text-2xl" /> "Location from
                      data"
                    </p>
                    <Link to="">CHANGE</Link>
                  </div>
                ...
                <div className="flex">
                  ...
                  <div className="flex flex-col items-start justify-between border">
                    <p className="text-xs opacity-[50%] p-2 gap-2">
                      Ship on Time
                    </p>
                  ...
                  <div className="flex flex-col items-start justify-between border-t-[1px] border-b-[1px] gap-2">
                    ...
                    <p className="text-xs opacity-[50%] px-3">
                      Not enough data
                    </p>
                  </div>
                </div>
      ...
      <div className="w-[80%] flex justify-start items-center bg-[#eff0f5]">
        {/* reviews and rating */}
        <div className="flex flex-col items-center w-full bg-[white] mb-5">
          <Ratings />
        </div>
